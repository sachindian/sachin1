...
<div class="container-fluid p-5  ">
	...
	<form method="POST"  class="d-flex">
		<select name="timezone" class="form-select form-select-lg  w-75">
			<option value="asia/kolkata">select timezone</option>
				<?php  foreach ($timezones as $key=>$value) {
					echo "<option value='$value'> $key</option>";}  ;?>
		</select>
	<button type="submit" class="btn btn-outline-primary w-25 ">Submit</button>	
	</form>
<table class=" table table-striped-columns text-center border border-black my-3">
	
	<tr>
		<th colspan="3"> Timezone</th>
		<th colspan="4"><?php echo $_POST['timezone'];?></th>
	</tr>
	<tr>
		<th>Year</th>
		<th>Month</th>
